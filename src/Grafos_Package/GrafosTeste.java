                ...
                switch (respostaMenuPrincipal) {
                    ...
                    case (12):
                        if (grafoAtual instanceof GrafoOrientado){
                            ...
                            System.out.println("O metodo de ordenacao topologica so podera ser utilizado em grafos orientados");
                        }
                        break;
                     case (13):
                        if (grafoAtual instanceof GrafoOrientado){
                            System.out.println(((GrafoOrientado) grafoAtual).fortementeConexo());
                        }else{
                            System.out.println("O metodo de componetes fortemente conexos so podera ser utilizado em grafos orientados");
                        }
                        break;
                    case(14):
                        if (grafoAtual instanceof GrafoNaoOrientado){
                            System.out.println(((GrafoNaoOrientado) grafoAtual).buscaDeArticulacao());
                        }else{
                            System.out.println("O metodo de busca de articulacoes so podera ser utilizado em grafos nao orientados");
                        }
                        break;
                    case (15):
                        if (grafoAtual instanceof GrafoNaoOrientado){
                            System.out.println(((GrafoNaoOrientado) grafoAtual).centroDoGrafo());
                        }else{
                            System.out.println("O metodo de centro do grafo so podera ser utilizado em grafos nao orientados");
                        }
                        break;
                    case (16):
                        if (grafoAtual instanceof GrafoNaoOrientado){
